...
export function initSettings(root, { onImported, onOpenLives } = {}) {
  root.innerHTML = `
    <div class="settings">
      ...
      <section class="settings-group">
        <h2 class="settings-h">The three areas — past · present · future</h2>
        <p class="field-hint" style="line-height:1.7">
          <strong>Memoir</strong> — your <em>past</em>, organized by <strong>category</strong> (homes, schools, jobs, people…). Add memories by hand, or tap “Talk it through” to gather them hands-free.<br>
          <strong>Diary</strong> — your <em>present</em>, organized by <strong>date</strong>: everyday entries, today by default.<br>
          <strong>Future</strong> — also by <strong>date</strong>, but <strong>generated by the app</strong>: an imagined continuation of your life, grounded in the past and present, that you can browse and hear.
        </p>
        <p class="field-hint">On <strong>Write</strong> these three guide what you add; on the <strong>Journal</strong> they guide how you browse.</p>
      </section>
